  ...
  return (
    <div className="container mx-auto px-3 my-10">
      ...
      <div className="relative">
        <div
          ref={containerRef}
          className="grid grid-cols-[repeat(auto-fit,220px)] grid-flow-col gap-8 overflow-hidden overflow-x-scroll relative z-10 scroll-smooth transition-all .scrolbar-none"
        >
          {data.map((data, index) => {
            return (
              <Card
